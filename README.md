...
Note: <mark style="background-color: #FFFF00">This project uses a PLL IP. The project was verified on a DE0-CV board using Quartus prime. Consider replacing the IP was a suitable one if you're using a different board or design software </mark>.
